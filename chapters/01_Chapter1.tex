...
\begin{tipbox}
\textbf{Companion notebook.} The code for this chapter is at \url{https://github.com/arunpshankar/packt-final} under \texttt{code/notebooks/part1\_foundations/}. To open in Colab, swap \texttt{github.com} for \texttt{githubtocolab.com} in the URL.
\end{tipbox}
