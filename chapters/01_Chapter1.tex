...
\begin{tipbox}
\textbf{Companion notebook.} The code for this chapter is in the book repository at \texttt{github.com/arunpshankar/packt-final}, under \texttt{code/notebooks/part1\_foundations/}. To open directly in Colab, replace \texttt{github.com} with \texttt{githubtocolab.com} in the URL.
\end{tipbox}
