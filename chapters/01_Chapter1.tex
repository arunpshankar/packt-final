...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.98\linewidth]{images/ch01_fig01_math_overview.png}
\caption{Chapter 1 at a glance -- a visual map of the essential math toolkit: probability, logarithms, expected value, summation, sigmoid, loss functions, gradient descent, and key notation.}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch01_fig01_probability_space.png}
\caption{Probability as area: the sample space $\Omega$ partitioned into overlapping events $A$ and $B$.}
\label{fig:ch01:probability}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch01_fig02_gradient_descent.png}
\caption{Gradient descent navigates a loss landscape by following the direction of steepest decrease.}
\label{fig:ch01:gradient}
\end{figure}
...
\texttt{code/notebooks/part1\_foundations/01\_math\_toolkit.ipynb}
