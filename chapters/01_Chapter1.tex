...
\begin{tipbox}
\textbf{Companion notebook.} Open \texttt{01\_math\_toolkit.ipynb} from the \texttt{part1\_foundations/} folder at \texttt{github.com/arunpshankar/packt-final}. Replace \texttt{github.com} with \texttt{githubtocolab.com} to launch directly in Colab.
\end{tipbox}
