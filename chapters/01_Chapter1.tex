...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The visual cheat sheet below brings all of these ideas together in one place -- keep it handy as you work through the rest of the book.
