...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of the alignment gap covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch02_fig01_alignment_gap.png}
\caption{The alignment gap -- from a pre-trained LLM that predicts tokens to an aligned assistant that is helpful, harmless, and honest.}
\label{fig:ch02:alignment}
\end{figure}
