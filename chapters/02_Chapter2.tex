...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch02_fig01_alignment_gap.png}
\caption{The alignment gap: a pre-trained LLM predicts tokens without values; RLHF bridges the gap to a helpful, harmless, and honest assistant.}
...
\texttt{code/notebooks/part1\_foundations/02\_alignment\_gap.ipynb}
