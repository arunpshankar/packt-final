...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of the RLHF pipeline covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch04_fig01_rlhf_overview.png}
\caption{RLHF: teaching AI with human values -- generate responses, collect preferences, train a reward model, and fine-tune with RL.}
