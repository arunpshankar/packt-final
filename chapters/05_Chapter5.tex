...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch05_fig01_sft_overview.png}
\caption{Supervised fine-tuning at a glance -- from pre-trained LLM to fine-tuned model via high-quality examples and cross-entropy loss.}
\label{fig:ch05:sft_overview}
\end{figure}
