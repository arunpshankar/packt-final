...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch05_fig01_sft_intro.png}
\caption{Supervised Fine-Tuning at a glance -- show the model good examples and ask it to copy them.}
\label{fig:ch05:sft_intro}
\end{figure}
...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of supervised fine-tuning covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch05_fig02_sft_detailed.png}
\caption{Supervised fine-tuning in depth -- the full pipeline from cold start and think-tag priming through LoRA adaptation and RL readiness.}
\label{fig:ch05:sft_detailed}
\end{figure}
