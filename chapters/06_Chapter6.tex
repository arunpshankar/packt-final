...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of the RLHF and PPO pipeline covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch06_fig02_rlhf_ppo_detailed.png}
\caption{RLHF and PPO in depth -- the full pipeline from preference data through reward model training, PPO objective, and end-to-end alignment.}
\label{fig:ch06:rlhf_ppo_detailed}
\end{figure}
