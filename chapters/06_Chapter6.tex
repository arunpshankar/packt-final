...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch06_fig01_rlhf_ppo_overview.png}
\caption{RLHF \& PPO at a glance -- collecting human preferences, training a reward model, and fine-tuning with PPO to produce an aligned LLM.}
\label{fig:ch06:rlhf_ppo_overview}
\end{figure}
