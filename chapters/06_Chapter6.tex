...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch06_fig01_rlhf_pipeline.png}
\caption{The RLHF three-step pipeline: supervised fine-tuning, reward model training on human preferences, and PPO policy optimisation.}
\label{fig:ch06:rlhf}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch06_fig02_ppo_clipping.png}
\caption{PPO clipping constrains the policy update ratio $r_t(\theta)$ to the interval $[1-\epsilon,\, 1+\epsilon]$, preventing destructively large steps.}
\label{fig:ch06:ppoclip}
\end{figure}
...
\texttt{code/notebooks/part2\_core/06\_rlhf\_ppo.ipynb}
