...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch07_fig01_dpo_intro.png}
\caption{Direct Preference Optimization at a glance -- skip the reward model and optimize the policy directly from preference pairs.}
\label{fig:ch07:dpo_intro}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch07_fig02_dpo_detailed.png}
\caption{DPO in depth -- the full derivation from preference pairs through the reparameterization trick, loss function, and comparison with RLHF.}
\label{fig:ch07:dpo_detailed}
\end{figure}
