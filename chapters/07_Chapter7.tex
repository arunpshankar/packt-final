...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch07_fig01_dpo_vs_rlhf.png}
\caption{DPO collapses the three-model RLHF pipeline into a single supervised objective, eliminating the need for an explicit reward model and RL loop.}
\label{fig:ch07:dpo}
\end{figure}
...
\texttt{code/notebooks/part2\_core/07\_dpo.ipynb}
