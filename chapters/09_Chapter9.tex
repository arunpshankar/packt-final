...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch09_fig01_reward_model_arch.png}
\caption{Reward model architecture: a transformer backbone with a linear scalar head trained to assign higher scores to preferred responses.}
\label{fig:ch09:rmarch}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch09_fig02_preference_annotation.png}
\caption{Human preference annotation pipeline: two responses are generated per prompt and a human annotator labels the preferred one.}
\label{fig:ch09:annotation}
\end{figure}
