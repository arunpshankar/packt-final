...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch09_fig01_reward_modeling_intro.png}
\caption{Reward modeling at a glance -- humans compare responses, the reward model learns to score them, and those scores drive better aligned policies.}
\label{fig:ch09:reward_modeling_intro}
\end{figure}
...
\begin{center}
\begin{tabular}{p{0.18\textwidth}p{0.20\textwidth}p{0.42\textwidth}}
\toprule
...
\begin{center}
\begin{tabular}{p{0.10\textwidth}p{0.16\textwidth}p{0.16\textwidth}p{0.36\textwidth}}
\toprule
