...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of reward modeling covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch09_fig01_reward_modeling_overview.png}
\caption{Reward modeling at a glance -- collect human preferences, train a scoring model, and use it to drive RL optimization toward aligned outputs.}
\label{fig:ch09:reward_modeling_overview}
\end{figure}
