...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch10_fig01_grpo_sampling.png}
\caption{GRPO group sampling: $G$ responses are generated per prompt and normalised within the group to form advantage estimates -- no critic network needed.}
\label{fig:ch10:grpo}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch10_fig02_algo_comparison.png}
\caption{Comparison of GRPO, RLOO, and KTO: they differ in how the baseline is computed, whether a reward model is required, and what signal drives the update.}
\label{fig:ch10:algos}
\end{figure}
...
\texttt{code/notebooks/part2\_core/10\_grpo\_rloo\_kto.ipynb}
