...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of GRPO, RLOO, and KTO covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch10_fig01_grpo_rloo_kto_overview.png}
\caption{Modern RL algorithms at a glance -- GRPO, RLOO, and KTO: three ways to compute advantages and update the policy without a critic.}
\label{fig:ch10:grpo_rloo_kto_overview}
\end{figure}
