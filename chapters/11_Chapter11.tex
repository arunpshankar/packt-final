...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of verifiers and outcome rewards covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch11_fig01_verifiers_overview.png}
\caption{Verifiers \& outcome rewards at a glance -- automatic correctness checking that provides fast, scalable, unhackable reward signals for RL.}
\label{fig:ch11:verifiers_overview}
\end{figure}
