...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch11_fig01_verifiers_intro.png}
\caption{Verifiers and outcome rewards at a glance -- when scores come from automatic checks instead of learned models.}
\label{fig:ch11:verifiers_intro}
\end{figure}
