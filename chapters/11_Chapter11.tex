...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch11_fig01_verifiable_vs_learned.png}
\caption{Verifiable rewards (right) provide ground-truth binary signal that cannot be hacked; learned reward models (left) are susceptible to distributional shift.}
\label{fig:ch11:verifiable}
\end{figure}
