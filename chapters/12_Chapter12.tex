...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of reasoning with GRPO covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch12_fig01_reasoning_grpo_overview.png}
\caption{Reasoning with GRPO (DeepSeek style) at a glance -- reward the reasoning process, not just the final answer, and let GRPO discover chain-of-thought strategies.}
\label{fig:ch12:reasoning_grpo_overview}
\end{figure}
