...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch12_fig01_reasoning_grpo_intro.png}
\caption{Reasoning with GRPO at a glance -- reward correctness and let the model discover chain-of-thought strategies on its own.}
\label{fig:ch12:reasoning_grpo_intro}
\end{figure}
