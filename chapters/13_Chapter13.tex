...
\chapter{Test-Time Compute: Scaling at Inference}
...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of test-time compute covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch13_fig01_test_time_compute_overview.png}
\caption{Test-time compute at a glance -- more thinking, better answers: self-consistency, tree search, and iterative refinement at inference time.}
\label{fig:ch13:test_time_compute_overview}
\end{figure}
