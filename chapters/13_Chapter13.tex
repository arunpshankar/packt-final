...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch13_fig01_inference_strategies.png}
\caption{Three test-time compute strategies: best-of-$N$ sampling, beam search, and MCTS tree search, ordered by compute cost and accuracy gain.}
\label{fig:ch13:strategies}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch13_fig02_scaling_curve.png}
\caption{Test-time compute scaling: accuracy improves log-linearly with the number of samples, with self-consistency and MCTS outperforming best-of-$N$.}
\label{fig:ch13:scaling}
\end{figure}
