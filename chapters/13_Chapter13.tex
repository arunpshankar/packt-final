...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch13_fig01_test_time_compute_intro.png}
\caption{Test-time compute at a glance -- spend extra computation per query to produce better answers without retraining the model.}
\label{fig:ch13:test_time_compute_intro}
\end{figure}
