...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch14_fig01_cai_pipeline.png}
\caption{Constitutional AI two-stage pipeline: SL-CAI uses self-critique and revision to generate training data; RL-CAI uses AI-generated preference labels.}
\label{fig:ch14:cai}
\end{figure}
