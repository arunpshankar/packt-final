...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch14_fig01_self_play_intro.png}
\caption{Self-play and Constitutional AI at a glance -- the self-improvement loop and the main methods that exploit the verify-easier-than-generate asymmetry.}
\label{fig:ch14:self_play_intro}
\end{figure}
