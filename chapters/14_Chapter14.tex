...
The companion code for this chapter is at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open it directly in Colab. The diagram below provides a visual summary of scaling RL systems covered in this chapter.

\clearpage
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch14_fig01_scaling_rl_overview.png}
\caption{Scaling RL at a glance -- from experiments to production: data pipelines, parallelism, memory management, monitoring, and deployment.}
\label{fig:ch14:scaling_rl_overview}
\end{figure}
