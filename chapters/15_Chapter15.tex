...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch15_fig01_multi_objective_intro.png}
\caption{Multi-objective RL and agentic systems at a glance -- balancing helpfulness, harmlessness, and honesty across long action trajectories.}
\label{fig:ch15:multi_objective_intro}
\end{figure}
