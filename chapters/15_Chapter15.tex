...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch15_fig01_pareto_frontier.png}
\caption{The Pareto frontier of helpfulness versus safety: no solution dominates all others on both objectives simultaneously.}
\label{fig:ch15:pareto}
\end{figure}
