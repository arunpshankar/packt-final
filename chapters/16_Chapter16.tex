...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch16_fig01_domain_rl_pipeline.png}
\caption{Domain-specific RL: the reward signal is provided by a domain verifier (code executor, symbolic math checker, or tool API) rather than a learned reward model.}
\label{fig:ch16:domain}
\end{figure}
