...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch17_fig01_chatbot_pipeline.png}
\caption{End-to-end chatbot training: SFT initialises the policy, a reward model is trained on preferences, and DPO aligns the final chatbot.}
\label{fig:ch17:chatbot}
\end{figure}
...
\begin{tipbox}
\textbf{Companion notebooks.} All notebooks are in \texttt{code/notebooks/} in the repository at
