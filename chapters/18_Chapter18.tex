...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch18_fig01_debugging_scaling_intro.png}
\caption{Debugging, scaling, and deployment at a glance -- failure modes, scaling techniques, and production evaluation across the RL system lifecycle.}
\label{fig:ch18:debugging_scaling_intro}
\end{figure}
...
The three recipe notebooks from Chapter~17 are the primary code companions for this chapter (\texttt{17\_recipe\_chatbot.ipynb}, \texttt{18\_recipe\_reasoner.ipynb}, \texttt{19\_recipe\_agent.ipynb}). All notebooks are at \texttt{github.com/arunpshankar/packt-final} -- swap \texttt{github.com} for \texttt{githubtocolab.com} to open directly in Colab.
