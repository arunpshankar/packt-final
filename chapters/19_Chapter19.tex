...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\linewidth]{images/ch19_fig01_agent_rl_loop.png}
\caption{Agent RL training loop: the policy executes multi-step tool-use trajectories and receives a delayed reward from a task verifier or human evaluator.}
\label{fig:ch19:agent}
\end{figure}
