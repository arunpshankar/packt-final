...
\begin{figure}[!h]
\centering
\includegraphics[width=0.88\textwidth]{images/ch19_fig01_journey_intro.png}
\caption{Your RL journey at a glance -- foundations to production, with guiding principles for building trustworthy systems.}
\label{fig:ch19:journey_intro}
\end{figure}
